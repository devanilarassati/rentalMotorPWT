...
<footer>
    <div class="container">
        ...
        <p>&copy; <?php echo date("Y"); ?> Rental Motor PWT, Inc. &middot; </p>
    </div>
</footer>
...
<script
    src="<?php echo base_url('assets/admin/plugins/validationengine/js/languages/jquery.validationEngine-en.js') ?>">
</script>
<script src="<?php echo base_url('assets/admin/plugins/jquery-validation-1.11.1/dist/jquery.validate.min.js') ?>">
</script>
