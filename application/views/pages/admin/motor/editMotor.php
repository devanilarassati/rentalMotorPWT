        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <form method="post" enctype="multipart/form-data"
                    action="<?php echo site_url('Admin_Controller/prosesEditmotor') ?>" class="form-horizontal"
                    id="popup-validation">
                    ...
                    <div class=" form-group">
                        ...
                        <div class="col-lg-4">
                            <input type="number" class="validate[required,custom[number]] form-control"
                                name="harga_rental" required>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="control-label col-lg-4">No Polisi</label>
                        <div class="col-lg-4">
                            <input type="number" class="validate[required,custom[number]] form-control" name="no_polisi"
                                required>
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-4">
                            <input type="text" class="validate[required] form-control" name="stok_motor" id="stok_motor"
                                required>
                        </div>
                    </div>
                    <div style="text-align:center" class="form-actions no-margin-bottom">
                        <button type="submit" class="btn btn-default btn-round">Submit</button>
                        <a href="<?php echo site_url('Admin_Controller/motor') ?>"
