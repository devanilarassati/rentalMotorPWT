...
<div class="row">
    <div class="col-lg-12">
        <div class="panel panel-default">
            ...
            <div class="panel-footer">
                <a href="<?php echo site_url('Admin_Controller/pemesanan') ?>" type="button"
                ...
                <?php if (isset($data_pemesanan)) {
                    foreach ($data_pemesanan as $row) {
                ?>
                <a type="button" class="btn btn-outline btn-warning btnPrint"
                    href="<?php echo site_url('Admin_Controller/printPemesanan/' . $row->id_pemesanan) ?>">
