    ...
    <div class="col-lg-12">
        <div class="box">
            ...
            <div id="collapse2" class="body collapse in">
                <form method="post" action="<?php echo site_url('Admin_Controller/prosesTambahcustomer') ?>"
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-4">
                            <select id="id_identitas" name="id_identitas" class="validate[required] form-control"
                                required>
