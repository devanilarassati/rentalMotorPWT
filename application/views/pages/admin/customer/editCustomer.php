    ...
    <div class="col-lg-12">
        <div class="box">
            ...
            <div id="collapse2" class="body collapse in">
                <form method="post" action="<?php echo site_url('Admin_Controller/prosesEditCustomer') ?>"
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-4">
                            <input type="text" class="validate[required,minSize[4]] form-control" name="username"
                    ...
                    <div class="form-group">
                        ...
                        <div class=" col-lg-4">
                            <input class="validate[required,minSize[4]] form-control" type="password" name="password"
                    ...
                    <div class="form-group">
                        ...
                        <div class=" col-lg-4">
                            <input class="validate[required] form-control" type="text" name="almt_user" id="almt_user"
                                value="<?php echo $row->almt_user; ?>">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="control-label col-lg-4">No Telepon</label>
                        <div class=" col-lg-4">
                            <input class="validate[required] form-control" type="number" name="notelp_user"
                    ...
                    <div class="form-group">
                        ...
                        <div class=" col-lg-4">
                            <input class="validate[required] form-control" type="email" name="email_user"
                    ...
                    <div style="text-align:center" class="form-actions no-margin-bottom">
                        ...
                        <a href="<?php echo site_url('Admin_Controller/Customer/') ?>"
