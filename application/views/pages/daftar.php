            ...
            <form method="post" action="<?php echo site_url('Login_Controller/prosesDaftar') ?>" id="popup-validation">
                ...
                <div class="col-sm-5">
                    <label for="nm_user" class="form-label">Nama Lengkap
                        <input type="text" class="validate[required,minSize[6]] form-control" name="nm_user"
                            id="nm_user" required></label>
                </div>
                <div class="col-sm-5">
                ...
                <div class="col-sm-5">
                    <label for="password" class="form-label">Password
                        <input type="password" class="validate[required,minSize[6]] form-control" name="password"
